...
from .game import Game, RANK_ORDER, beats, rank, suit, lowest_card


def choose_attack(game: Game, player: int) -> str:
    """Fase attack: la carta più bassa della mano."""
...
def choose_move(game: Game, player: int) -> dict:
    ...
    if game.phase == "attack":
        return {"action": "attack", "card": choose_attack(game, player)}
